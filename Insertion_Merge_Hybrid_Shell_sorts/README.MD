For this project, I was using C++11 for my code. I also had an extra file "helper_functions.cpp" in which I implemented a merger fucntion (merge 2 sub vectors) and a printVector function.
